...
class QodeFrameworkFieldIcon extends QodeFrameworkFieldType {
	...
	function __construct( $params ) {
        ...
        if ( isset( $params['title'] ) && $params['title'] == 'Material Icons' ) { // Material Icons won't show with fontIconPicker script because of HTML structure. We need to trigger select2 script
            $select_class = 'qodef-select2';
        }
