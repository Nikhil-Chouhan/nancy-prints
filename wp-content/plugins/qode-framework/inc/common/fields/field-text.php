...
class QodeFrameworkFieldText extends QodeFrameworkFieldType {
    ...
    public function render_field() { ?>
	    ...
	    <?php endif; ?>
		    ...
		    <?php endif; ?>
	        <input type="text" <?php echo qode_framework_get_inline_attrs( $this->data_attrs ); ?> class="qodef-field qodef-input" name="<?php echo esc_attr( $this->name ); ?>" value="<?php echo esc_attr( esc_html( $this->params['value'] ) ); ?>" <?php if ( isset( $this->args['readonly'] ) ) { echo 'readonly'; } ?> />
