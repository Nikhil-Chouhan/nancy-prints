...
class QodeFrameworkFieldWidgetColor extends QodeFrameworkFieldWidgetType {
	...
	public function load_assets() {
		...
		wp_enqueue_script( 'wp-color-picker-alpha', QODE_FRAMEWORK_INC_URL_PATH . '/common/assets/plugins/wp-color-picker-alpha/wp-color-picker-alpha.min.js', array( 'wp-color-picker' ) );
	}
